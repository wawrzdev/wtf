...
```sh
mise --no-config exec go@latest -- gofmt -w .
mise --no-config exec go@latest -- go test ./...
mise --no-config exec go@latest -- go vet ./...
mise --no-config exec go@latest -- go test -race ./...
```
